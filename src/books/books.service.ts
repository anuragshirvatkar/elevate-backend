...
export class BooksService {
  ...
  async createCustom(
    ...
    const duplicateWhere = dto.author !== undefined
      ? { user_id: userId, title, books_catalog: { author: dto.author } }
    ...
    const catalogEntry = await this.prisma.books_catalog.create({
      data: {
        title,
        author: dto.author ?? null,
        default_total_pages: dto.pages ?? null,
      },
    });
